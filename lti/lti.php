...
// Seem it is on Dashboard
//echo "lti_db_connector= <br>"; print_r($lti_db_connector); 
//echo "lti_options_page= <br>"; print_r($lti_options_page); 
//echo "current_user= <br>"; print_r($current_user); 
