...
function lti_do_connect($tool_provider) {
  ...
  $user_login = $tool_provider->user->getID($scope_userid);
   ...
   // UPDATED BY W PAN
   // make user_login better 
   	$temp_1 = $user_login;
	$pos_1  = strrpos($temp_1, ":"); 
	if($pos_1 > 0) {
	  $temp_2 = substr($temp_1, 0, $pos_1);
	  $temp_3 = substr($temp_1, $pos_1);
	 // echo "pos_1=$pos_1; temp_2=$temp_2; temp_3=$temp_3<br>";  
	  if (strrpos($temp_2, $temp_3) > 0) $user_login = $temp_2; 	  	
	}   
   // END of UPDATED BY W PAN
